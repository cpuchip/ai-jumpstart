...
- Assistant owns: [e.g., implementation within src/, the journal, proposals]
- Assistant never touches without asking: [e.g., deployment, deletion, anything
  outside the project folder, spending money]
- Budget / report-back: [e.g., "check in after each phase"; "stop at $X"; "anything
  irreversible is mine"]
